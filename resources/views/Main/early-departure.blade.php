...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-4 px-2 sm:px-6 lg:px-8">
    ...
    <div class="mt-6 mx-auto w-full max-w-xs sm:max-w-sm md:max-w-md">
        <div class="bg-white py-6 px-4 shadow rounded-lg sm:px-6">
            <form class="space-y-4" action="{{ route('early-departure.store') }}" method="POST">
                @csrf
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="current_time" name="current_time" type="text" value="{{ $earlyEntry->time }}" readonly 
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="nis" name="nis" type="text" value="{{ $earlyEntry->nis }}" readonly 
                            class="bg-gray-100 w-full px-2 py-1.5 text-xs sm:text-sm border border-gray-300 rounded-md shadow-sm">
                    </div>
                </div>
                ...
                <div>
                    <label for="alasan" class="block text-xs sm:text-sm font-medium text-gray-700">Alasan Pulang Lebih Awal <span class="font-bold text-red-600">*</span></label>
                    <div class="mt-1">
                        <textarea id="alasan" name="alasan" rows="2"
                            ...
                            placeholder="Masukkan alasan pulang lebih awal"></textarea>
                    </div>
                </div>
