        ...
        <form method="GET" action="{{ route('siswa') }}" class="flex flex-col md:flex-row justify-between gap-4 mb-6 w-full">
            ...
            <div class="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
                ...
                <button type="button" onclick="openImportModal()"
                    class="w-full sm:w-auto bg-blue-500 text-center max-sm:text-xs hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-md whitespace-nowrap">
                    <i class="bi bi-file-earmark-excel mr-1"></i> Import Excel
                </button>

                <a href="{{ route('siswa.add') }}"
                    class="w-full sm:w-auto bg-green-500 text-center max-sm:text-xs hover:bg-green-600 text-white font-bold py-2 px-4 rounded-md whitespace-nowrap">
                    Tambah Siswa
                </a>
            </div>
        </form>
