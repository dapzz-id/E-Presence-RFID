    ...
    <form action="{{ route('akun.siswa.create.post') }}" method="POST" class="space-y-4 sm:space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-6">
            <div>
                ...
                <input type="text" id="no_ortu" value="{{ old('no_ortu') }}" name="no_ortu" class="w-full px-3 py-1.5 sm:px-4 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm" placeholder="08xxxxxxxxxx">
