...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-4 px-2 sm:px-6 lg:px-8">
    ...
    <div class="mt-6 mx-auto w-full max-w-xs sm:max-w-sm md:max-w-md">
        <div class="bg-white py-6 px-4 shadow rounded-lg sm:px-6">
            <form class="space-y-4" action="{{ route('late-arrival.store') }}" method="POST">
                @csrf
                ...
                <div>
                    <label for="alasan" class="block text-xs sm:text-sm font-medium text-gray-700">Alasan Telat Datang <span class="font-bold text-red-600">*</span></label>
                    <div class="mt-1">
